  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col">
          <button formaction="{{route('shipped.store')}}" id="showSelected" class="btn btn-primary">Shipped</button>
          <button id="printSelected" class="btn btn-primary">Print Invoice</button>
        </div>
      </div>
