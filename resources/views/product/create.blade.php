...
<div class="container-fluid" >
  <form action="{{route('product.store')}}" method="POST" id="submitProductForm" enctype="multipart/form-data">
    @csrf
    <div class="row">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <select name="sub-category" id="subCategorySelector" class="form-control">
                  </select>
                </div>
              </div>
            </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="custom-control custom-switch">
                        ...
                        <label class="custom-control-label" for="saleAvailability">Sale</label>
                      </div>
                    </td>
                    <td>
        ...
        <div class="card shadow mb-3">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" placeholder="-" list="warrantyScheme" class="form-control @error('color') is-invalid @enderror" name="color" value="{{ old('color') }}">
